...
public class RareEngieTameRCProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new RareEngieSharkoLayEntity(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO_LAY.get(), _level);
