...
public class RareEngie2RCTameProcedure {
			...
			if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.COOKIE) {
				if (Math.random() >= 0.8) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = new RareEngieSharkoTamed2Entity(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO_TAMED_2.get(), _level);
