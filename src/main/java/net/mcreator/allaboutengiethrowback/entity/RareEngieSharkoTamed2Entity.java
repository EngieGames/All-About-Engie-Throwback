...
import net.mcreator.allaboutengiethrowback.procedures.RareEngie2TameRCProcedure;
import net.mcreator.allaboutengiethrowback.init.AllAboutEngieThrowbackModEntities;

public class RareEngieSharkoTamed2Entity extends PathfinderMob {
	public RareEngieSharkoTamed2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO_TAMED_2.get(), world);
	}

	public RareEngieSharkoTamed2Entity(EntityType<RareEngieSharkoTamed2Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareEngie2TameRCProcedure.execute(world, x, y, z, entity);
		return retval;
	}
