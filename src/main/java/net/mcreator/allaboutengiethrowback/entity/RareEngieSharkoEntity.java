...
import net.mcreator.allaboutengiethrowback.procedures.RareEngieRCTameProcedure;
import net.mcreator.allaboutengiethrowback.init.AllAboutEngieThrowbackModEntities;

public class RareEngieSharkoEntity extends PathfinderMob {
	public RareEngieSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareEngieRCTameProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
