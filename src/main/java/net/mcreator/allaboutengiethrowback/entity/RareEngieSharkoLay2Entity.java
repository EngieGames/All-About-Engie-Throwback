...
import net.mcreator.allaboutengiethrowback.procedures.RareEngie2LayRCProcedure;
import net.mcreator.allaboutengiethrowback.init.AllAboutEngieThrowbackModEntities;

public class RareEngieSharkoLay2Entity extends PathfinderMob {
	public RareEngieSharkoLay2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO_LAY_2.get(), world);
	}

	public RareEngieSharkoLay2Entity(EntityType<RareEngieSharkoLay2Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareEngie2LayRCProcedure.execute(world, x, y, z, entity);
		return retval;
	}
