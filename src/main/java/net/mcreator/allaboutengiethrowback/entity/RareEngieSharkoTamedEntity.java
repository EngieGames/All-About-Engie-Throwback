...
import net.mcreator.allaboutengiethrowback.procedures.RareEngieTameRCProcedure;
import net.mcreator.allaboutengiethrowback.init.AllAboutEngieThrowbackModEntities;

public class RareEngieSharkoTamedEntity extends PathfinderMob {
	public RareEngieSharkoTamedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO_TAMED.get(), world);
	}

	public RareEngieSharkoTamedEntity(EntityType<RareEngieSharkoTamedEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareEngieTameRCProcedure.execute(world, x, y, z, entity);
		return retval;
	}
