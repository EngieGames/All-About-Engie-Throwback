...
import net.mcreator.allaboutengiethrowback.procedures.MythicRCTameProcedure;
...
public class MythicSharkoEntity extends PathfinderMob {
	public MythicSharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.MYTHIC_SHARKO.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllAboutEngieThrowbackModEntities.MYTHIC_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
