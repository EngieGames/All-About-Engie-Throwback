...
public class AngryCreatorEntity extends Monster {
	public AngryCreatorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.ANGRY_CREATOR.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllAboutEngieThrowbackModEntities.ANGRY_CREATOR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
