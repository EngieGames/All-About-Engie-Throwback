...
public class EnragedEngiEntity extends Monster {
	public EnragedEngiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.ENRAGED_ENGI.get(), world);
	}

	public EnragedEngiEntity(EntityType<EnragedEngiEntity> type, Level world) {
		super(type, world);
		xpReward = 25;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AllAboutEngieThrowbackModItems.ENRAGED_ENGI_ESSENCE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(AllAboutEngieThrowbackModEntities.ENRAGED_ENGI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
