...
import net.mcreator.allaboutengiethrowback.procedures.LegendaryRCTameProcedure;
...
public class LegendarySharkoEntity extends PathfinderMob {
	public LegendarySharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.LEGENDARY_SHARKO.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllAboutEngieThrowbackModEntities.LEGENDARY_SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
