...
import net.mcreator.allaboutengiethrowback.procedures.RareEngieLayRCProcedure;
import net.mcreator.allaboutengiethrowback.init.AllAboutEngieThrowbackModEntities;

public class RareEngieSharkoLayEntity extends PathfinderMob {
	public RareEngieSharkoLayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.RARE_ENGIE_SHARKO_LAY.get(), world);
	}

	public RareEngieSharkoLayEntity(EntityType<RareEngieSharkoLayEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		RareEngieLayRCProcedure.execute(world, x, y, z, entity);
		return retval;
	}
