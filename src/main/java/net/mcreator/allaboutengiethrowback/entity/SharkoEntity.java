...
import net.mcreator.allaboutengiethrowback.procedures.SharkoRCTameProcedure;
...
public class SharkoEntity extends PathfinderMob {
	public SharkoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.SHARKO.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllAboutEngieThrowbackModEntities.SHARKO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
