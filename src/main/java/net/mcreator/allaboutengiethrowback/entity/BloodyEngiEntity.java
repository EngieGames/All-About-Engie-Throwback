...
public class BloodyEngiEntity extends Monster {
	public BloodyEngiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllAboutEngieThrowbackModEntities.BLOODY_ENGI.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AllAboutEngieThrowbackModEntities.BLOODY_ENGI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
