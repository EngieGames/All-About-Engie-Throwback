...
public abstract class SharkItem extends ArmorItem {
	...
	public static class Helmet extends SharkItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/sharkothrowback__layer_1.png";
		}
	}
	...
	public static class Leggings extends SharkItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/sharkothrowback__layer_2.png";
		}
	}
