...
public abstract class MythicSharkItem extends ArmorItem {
	...
	public static class Helmet extends MythicSharkItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/mythicsharkothrowback__layer_1.png";
		}
	}
	...
	public static class Leggings extends MythicSharkItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/mythicsharkothrowback__layer_2.png";
		}
	}
