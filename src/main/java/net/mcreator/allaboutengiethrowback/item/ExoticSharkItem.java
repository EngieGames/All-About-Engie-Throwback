...
public abstract class ExoticSharkItem extends ArmorItem {
	...
	public static class Helmet extends ExoticSharkItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/exoticsharkothrowback__layer_1.png";
		}
	}
	...
	public static class Leggings extends ExoticSharkItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/exoticsharkothrowback__layer_2.png";
		}
	}
