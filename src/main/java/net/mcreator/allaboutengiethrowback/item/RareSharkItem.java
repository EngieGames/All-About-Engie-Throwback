...
public abstract class RareSharkItem extends ArmorItem {
	...
	public static class Helmet extends RareSharkItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/raresharkothrowback__layer_1.png";
		}
	}
	...
	public static class Leggings extends RareSharkItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/raresharkothrowback__layer_2.png";
		}
	}
