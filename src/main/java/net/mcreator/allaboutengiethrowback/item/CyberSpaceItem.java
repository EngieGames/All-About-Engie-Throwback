...
public class CyberSpaceItem extends Item {
	public CyberSpaceItem() {
		super(new Item.Properties().tab(AllAboutEngieThrowbackModTabs.TAB_ITEMS).durability(64));
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				CyberSpacePortalBlock.portalSpawn(world, pos);
