...
public class BloodSpaceItem extends Item {
	public BloodSpaceItem() {
		super(new Item.Properties().tab(AllAboutEngieThrowbackModTabs.TAB_TOOLS).durability(64));
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				BloodSpacePortalBlock.portalSpawn(world, pos);
