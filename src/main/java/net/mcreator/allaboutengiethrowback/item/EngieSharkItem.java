...
public abstract class EngieSharkItem extends ArmorItem {
	...
	public static class Helmet extends EngieSharkItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/engiesharkothrowback__layer_1.png";
		}
	}
	...
	public static class Leggings extends EngieSharkItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "all_about_engie_throwback:textures/models/armor/engiesharkothrowback__layer_2.png";
		}
	}
